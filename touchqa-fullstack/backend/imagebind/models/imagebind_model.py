...
def imagebind_huge(pretrained=False):
    ...
    if pretrained:
        if not os.path.exists("imagebind/.checkpoints/imagebind_huge.pth"):
            print(
            ...
            torch.hub.download_url_to_file(
                ...
                "imagebind/.checkpoints/imagebind_huge.pth",
                progress=True,
            )

        model.load_state_dict(torch.load("imagebind/.checkpoints/imagebind_huge.pth"))
